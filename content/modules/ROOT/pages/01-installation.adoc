...
NOTE: The commands below were written for *RHEL 9*. If you are running on *macOS*, be aware of two differences: +
...
TIP: If you are using *ROSA (Red Hat OpenShift Service on AWS)* with Hosted Control Planes, ACM can provision and auto-import ROSA HCP clusters using CAPI instead of Hive. See the https://cloud.redhat.com/experts/rosa/acm/[Deploy ROSA with RHACM] guide for that workflow.
