...
[IMPORTANT]
====
The Application Subscription model (Channel, Subscription, PlacementRule) is *deprecated since ACM 2.13*. The recommended approach is *OpenShift GitOps with ArgoCD*. This module presents ArgoCD first as the primary method, with the legacy Subscription approach available as a reference appendix.
====
...
image::application-dev.png[application-dev]
...
image::application-prod.png[application-prod]
...
[NOTE]
====
All of the resources you have configured in this exercise are present in the https://github.com/tosin2013/rhacm-workshop.git[git repository]. The resources can be created by running the next command -
====
