...
Make sure that the ArgoCD instance is running by navigating to ArgoCD's web UI. The URL can be found by running the next command -
...
The applications use the same baseline Kubernetes resources at - {workshop_repo}/tree/master/04.Application-Lifecycle/exercise-argocd/application-resources/templates[exercise-argocd/application-resources/templates], but they use different `values` files at - {workshop_repo}/tree/master/04.Application-Lifecycle/exercise-argocd/application-resources/values[exercise-argocd/application-resources/values]. Each instance of the application uses a separate values set. The ApplicationSet resource iterates over the directories in the {workshop_repo}/tree/master/04.Application-Lifecycle/exercise-argocd/application-resources/values[exercise-argocd/application-resources/values] directory and creates an instance of an application for each directory name.
