...
2. Copy the cluster pull secret
3. Create an ObjectBucketClaim via NooBaa and wait for it to bind
4. Extract bucket credentials and create the `thanos-object-storage` secret
5. Auto-detect the storage class for StatefulSets
6. Apply the `MultiClusterObservability` CR
...
![grafana-explore-builder](images/grafana-explore-builder-mode.png)
...
![grafana-memory-query](images/grafana-explore-memory-query.png)
...
![grafana-alerts-query](images/grafana-explore-alerts-query.png)
...
![grafana-etcd-size-query](images/grafana-explore-etcd-size-query.png)
