...
Open the **Cluster Node Resources** dashboard. Use the **Cluster** dropdown at the top to select `standard-cluster`:

![cluster-node-resources-dashboard](images/cluster-node-resources-dashboard.png)

Verify the values match by querying the standard-cluster metrics via Thanos:
